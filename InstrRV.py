...
class InstrRV:
    ...
    # ────────────────────────────────────────────────────────────────────────
    #  Imprimir el formato de una instruccion de tipo I en blanco y negro
    # ────────────────────────────────────────────────────────────────────────
    def _print_isa_tipo_I_BW(self) -> None:
        ...
        print(f"   │  {self.rd:02}   │ {self.opcode:#04x}   │")
        print("├──────────┼───────┼───────┼───────┼────────┤")
    ...
    # ───────────────────────────────────────────────────────────
    #  Imprimir el formato de una instruccion de tipo I en color
    # ───────────────────────────────────────────────────────────
    def _print_isa_tipo_I_color(self):
        ...
        print("│ imm12    │ rs1   │ func3 │  rd   │ opcode │")
        print(f"{C1}│ ", end='')
        print(f"{C2}{self.imm12:#05x}    ", end='')
        print(f"{C1}│ ", end='')
        print(f"{C2}{self.rs1:02}    ", end='')
        print(f"{C1}│ ", end='')
        print(f"{C2}{self.func3}     ", end='')
        print(f"{C1}│", end='')
        print(f"{C2}  {self.rd:02}   ", end='')
        print(f"{C1}│", end='')
        print(f"{C2} {self.opcode:#04x}   ", end='')
        print(f"{C1}│")
        print("├──────────┼───────┼───────┼───────┼────────┤")
        print(f"{C1}│", end='')
        print(f"{C0}ᐊ────────ᐅ", end='')
    ...
    # ─────────────────────────────────────────────────────────
    #  Imprimir el formato de una instruccion de tipo I
    # ─────────────────────────────────────────────────────────
    def _print_isa_tipo_I(self, color: bool = True):
        if color:
            self._print_isa_tipo_I_color()
        else:
